...
/**
 * Z racji że w zorze określającym modyfikator jest użuta podłoga( nie formalnie)
 * to określenie wartości staje się cięższe.
 * @author bambucha
 */
public class BonusHandlerTest
{
    DnDAbilities x = new DnDAbilities(null, null);
