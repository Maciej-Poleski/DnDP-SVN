...
/**
 * Fasada do bazy danych
 * Wzorze projektowy singleton
 * Przeglądnąć na koniec
 * @author bambucha
 */
public class FrontToDB
{
    ...
    {
        DB = Db4oClientServer.openClient(prop.getProperty("DB URL"), Integer.parseInt(prop.getProperty("DB PORT")), prop.getProperty("DB USER"), prop.getProperty("DB PASSWORD"));
    }

    /**
     * Zwraca referencję do fasady bazy dancyh, jeśli ona istnieje, w przeciwmym wypadku rzuca wyjątkiem
     * @return Referencje fasady do bazy danych
     * @throws IllegalStateException gdy jeszcze nie zbudowany
     */
...
//          throw new IllegalStateException("Brak obiektu");
     ...
     * @param user Użytkownik do bazy danych
