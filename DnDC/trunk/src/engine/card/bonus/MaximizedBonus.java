...
/**
 * Typ premi maksymalizowanej.
 * Oznacza to że jako bonus bierzę się maksymalną wartośc wynikającą z danego atrybutu.
 * @par TODO
 *  Implementacja multiset'a na kopcu
 * @author bambucha
 */
public class MaximizedBonus implements Bonus
{
    ...
    {
        this.bonusSet = Collections.synchronizedSortedMap(new TreeMap<Integer,Integer>());
        bonusSet.put(0,0);
    }
