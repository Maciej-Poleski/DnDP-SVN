...
/**
 * Zajmuje się obsługą, pomocników liczących premię.
 * Przez tą klasę trzeba przepychać wszytkie zmianny.
 * Wzorzec projektowy singleton.
 * @par TODO
 *  Zastanowienie się nad potrzebą wprowadzenia przestrzeni nazw (z góry określonej jakiej), i wprowadznie takowej.
 * @author bambucha
 */
public class DnDBonusManager implements BonusManager
{
     ...
     * @param newBonus Pole wymagające
     * @param name Nawa pola
     */
    @Override
