 ...
 * efekty działąjące na postac.
 * Koncepcja jest dziwna i dość mętna.
 * Klasa mocno rowojowa, prawdopodobnie wielowątkowa :)
 *
 *
 * @author bambucha
 */
public class StateReactor extends Thread
{
     ...
     * @param x Stan do dodania
     * @param lenght Czas trwania efektu
     */
    ...
    public void run()
    {
        ...
        {
            Logger.getLogger(StateReactor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
