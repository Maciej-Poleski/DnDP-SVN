...
public interface BasicEquipmentManager
{
    ...
    /**
     * Powoduje zaaplikownaie na postaci premi przedmiotu.
     * Wywołuwać podczas, ubierania przedmiotów, oraz wyciągania ich w celu użycia, np magiczego miecza z pochwy.
     * @param what Przedmiot
     */
    ...
    /**
     * Zwraca karę do testów umiejętności wynikającą z pancerza.
     * Uwzględnia cały ekwipunek.
